...
function PingMiniMap(msg) {
  GameUI.PingMinimapAtLocation(msg.loc);
}

(function () {
  GameUI.TopNotification = TopNotification;
  GameUI.BottomNotification = BottomNotification;
  ...
  GameEvents.Subscribe("frd_ping_minimap", PingMiniMap);
})();
